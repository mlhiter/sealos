...
export async function GET(req: NextRequest, { params }: { params: { name: string } }) {
  try {
    ...
    const rawSpecConfigForTemplate = (devboxBody.spec?.config as any) || {};
    const fallbackTemplateConfig = JSON.stringify(rawSpecConfigForTemplate);
